<div x-show="{{$modalActive}}" style="display: none;" class="fixed inset-0 z-40 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="{{$modalActive}}"
            ...
            class="w-full inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl  sm:align-middle sm:max-w-sm sm:w-full  lg:max-w-xl xl:max-w-{{$modalSize}}"
            role="dialog" aria-modal="true" aria-labelledby="modal-headline"
        >

            <div>
                <div class="pb-4">
                    <div class="relative flex items-center justify-between font-semibold py-2 px-2 mb-4 bg-yellow-300  text-black ">
